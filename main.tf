...
provider "azurerm" {
  ...
  subscription_id = module.basic.subscription-id
  tenant_id       = module.basic.tenant-id
  features {}
}

resource "azurerm_resource_group" "vnet" {
  name     = module.basic.resource-group
...
module "hub_network" {
  source              = "private-aks\/modules/vnet"
...
module "vnet_peering" {
  source              = "private-aks\/modules/vnet_peering"
...
module "firewall" {
  source         = "private-aks\/modules/firewall"
